...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { value: "ppm-compliance", label: "PPM Compliance", icon: "ti-clipboard-check" },
      { value: "site-autonomy", label: "Site Autonomy", icon: "ti-adjustments" },
      { value: "service-categories", label: "Service Categories", icon: "ti-category" },
      { value: "site-contacts", label: "Site Contacts", icon: "ti-users" },
    ],
  },
  {
    group: "Contractors",
...
const VIEW_LABELS: Record<string, string> = {
  ...
  groups:     "Site Groups",
  "ppm-compliance": "PPM Compliance",
  "site-autonomy": "Site Autonomy",
