...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { value: "engagements", label: "Engagements", icon: "ti-file-certificate" },
...
const VIEW_SUBTITLES: Record<string, string> = {
  ...
  engagements: "Standing term engagements with your business clients, and rates awaiting your acceptance",
